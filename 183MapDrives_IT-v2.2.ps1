...
$DepartmentsRoot = "\\L183FS01\Departments"
...
New-PSDrive -Name "T" -PSProvider FileSystem -Description "IT test" -Root "\\L183FS01\Departments\It\Shared Docs" -Persist
...
{
    New-PSDrive -Name "Z" -PSProvider FileSystem -Description "IT SHARED DOCS" -Root "\\L183FS01\Departments\IT\Shared Docs" -Credential $cred -Persist -scope global
...
{
   New-PSDrive -Name "Z:" -PSProvider FileSystem -Description "IT test" -Root "\\L183FS01\Departments\IT\Shared Docs" -Credential $cred -Persist -scope global
   (New-Object -ComObject Shell.Application).NameSpace("Z:").Self.Name="IT Shared Docs"  
}